...
namespace merge_sort_tests
{
    ...
    public class UnitTest1
    {
        ...
        public void TestMethod1()
        {
            ...
            // Act
            programLogic.mergeSort(list2a);
            programLogic.mergeSort(list2b);
            programLogic.mergeSort(list9a);
            programLogic.mergeSort(list9b);
            programLogic.mergeSort(list9c);
            programLogic.mergeSort(list9d);
            programLogic.mergeSort(list9e);
            programLogic.mergeSort(list9f);
            programLogic.mergeSort(list9g);
            programLogic.mergeSort(listEmpty);
            programLogic.mergeSort(list1a);
